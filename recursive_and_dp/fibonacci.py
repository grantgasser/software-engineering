...
"""
Python Memoization/Caching:
Cool, just take original recursive function and add decorator
"""
from functools import lru_cache

@lru_cache(maxsize=1000)  # how many prev calls to cache
def fibonacci(n):
    if n == 1:
        return 1
    elif n == 2:
